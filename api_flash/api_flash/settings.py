...
EMAIL_HOST = 'mail.zandosoft.com'  # Adresse du serveur SMTP
...
EMAIL_HOST_USER = 'DoNotReply@zandosoft.com'  # Votre adresse e-mail
EMAIL_HOST_PASSWORD = 'XuX2pow8**'  # Votre mot de passe
